    ...
    <section className="forgot-password-page">
      ...
      <div className="forgot-password-layout">
        <div className="forgot-password-hero">
          <span className="forgot-password-hero__badge">Password Recovery</span>
          <h1>Recover access and get back to daily operations quickly.</h1>
          <p>
            Request a secure reset link for your account and continue managing
            vehicles and service updates.
          </p>
