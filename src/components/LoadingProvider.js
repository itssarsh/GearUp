    ...
    <LoadingContext.Provider value={value}>
      ...
      {isVisible && (
        <div className="global-loader" aria-live="assertive" aria-busy="true">
          ...
          <div className="global-loader__panel" role="status" aria-label="Loading customer workspace">
            <div className="global-loader__spinner" aria-hidden="true"></div>
            <strong>Loading workspace</strong>
            <span>Preparing your latest vehicles, bookings, and workshop activity.</span>
          </div>
        </div>
      )}
